...
import { getUser, saveUser, clearActiveRaid, addGrudge, getGrudges, addRaidHist, recentRaiders, tgNotify, syncLb } from './db.js';
import { collect, resolveRaid, mutualRaidPenalty, coalitionBonus, warLevel } from './game.js';

export const RAID_PREP_MS = 30 * 1000; // 30 sn hazırlık ("çürüme" penceresi)
